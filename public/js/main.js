...
// Используем async/await для работы с асинхронными операциями
async function loadStocks() {
    try {
        // fetch возвращает Promise, который мы обрабатываем с помощью await
        ...
        // Преобразуем ответ в JSON, response.json() также возвращает Promise
        ...
        // Это заменяет .catch() при использовании цепочки Promise
